...
@JsonIgnoreProperties(ignoreUnknown = true) //tabla principal
public class Commit {
    ...
    @JsonProperty("short_id") //propiedades extras
     ...
     * @param createdAt
     */
    public Commit(String id, String shortId, String title, String authorName, String authorEmail, String authoredDate, String committerName, String committerEmail, String committedDate, String createdAt, String message, List<String> parentIds, String webUrl) {
        super();
        this.id = id;
        this.title = title;
