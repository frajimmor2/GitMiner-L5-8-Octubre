...
public class IssueSearch {
    ...
    @JsonProperty("author")
    private UserIssueSearch author;
    @JsonProperty("type")
    private String type;
    @JsonProperty("assignee")
    private UserIssueSearch assignee;
    ...
    @JsonProperty("author")
    public UserIssueSearch getAuthor() {
        return author;
    }

    @JsonProperty("author")
    public void setAuthor(UserIssueSearch author) {
        this.author = author;
    }
    ...
    @JsonProperty("assignee")
    public UserIssueSearch getAssignee() {
        return assignee;
    }

    @JsonProperty("assignee")
    public void setAssignee(UserIssueSearch assignee) {
