...
public class UserOfComment {

    @JsonProperty("login")
    private String username;    //Actualizado al que se usará en el post
    @JsonProperty("id")
    private Integer id;
    ...
    private String webUrl;         //Actualizado según modelo.
    ...
    public String toString() {
        ...
        sb.append(UserOfComment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("login");
        sb.append('=');
