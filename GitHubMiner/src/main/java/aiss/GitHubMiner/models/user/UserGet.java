...
package aiss.GitHubMiner.models.user;
...
public class UserGet {
    ...
    @JsonProperty("login")
    private String username;        //Vamos cambiando ya el nombre, para recordarlo en el post.
    @JsonProperty("id")
    private Integer id;
    ...
    public String toString() {
        ...
        sb.append(UserGet.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("login");
        sb.append('=');
