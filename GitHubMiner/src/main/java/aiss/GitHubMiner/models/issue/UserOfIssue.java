...
public class UserOfIssue {     //No incluye la propiedad name, por lo que habrá que hacer búsquedas con otra clase user para obtenerlo.
    ...
    private String webUrl;      //Uri que vamos a usar para obtener el name del modelo.
    ...
    public String toString() {
        ...
        sb.append(UserOfIssue.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("login");
        sb.append('=');
